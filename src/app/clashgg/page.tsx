                ...
                <div className="p-10 w-full flex justify-center items-center h-[400px] mt-20">
                    {loading ? <div className="w-full h-screen flex justify-center items-center">
                        ...
                        <div className="w-full flex justify-center gap-20 perspective">
                            <SpotlightCard className="translate-y-12 border-border hover:border-secondary/80 bg-gradient-to-br from-card via-[#0a1c05] to-card relative rotate-3d-left hover:scale-105 group transition-all duration-500 ease-initial" spotlightColor="rgba(22, 36, 86, 0.4)">
                            ...
                            <div className="relative">
                                ...
                                <SpotlightCard className="relative border-border hover:border-secondary/80 bg-gradient-to-br from-card via-[#0a1c05] to-card hover:scale-105 transition-all duration-500 group ease-initial" spotlightColor="rgba(22, 36, 86, 0.4)">
                                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-card border-2 transition-all duration-500 ease-initial group-hover:border-secondary via-border to-card text-primary font-semibold w-12 h-12 flex items-center text-sm justify-center rounded-full shadow-md z-10">
                                        #1
                                    </div>
                            ...
                            <SpotlightCard className="translate-y-12 border-border hover:border-secondary/80 bg-gradient-to-br from-card via-[#0a1c05] to-card relative rotate-3d-right hover:scale-105 group transition-all duration-500 ease-initial" spotlightColor="rgba(22, 36, 86, 0.4)">
                                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-card border-2 transition-all duration-500 ease-initial group-hover:border-secondary via-border to-card text-primary font-semibold w-12 h-12 flex items-center text-sm justify-center rounded-full shadow-md z-10">
                                    #3
                                </div>
                                <div className="w-[260px] h-[400px]">
