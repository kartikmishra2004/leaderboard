...
export default function ClashGG() {
    ...
    return (
        <section ref={mainRef} className="w-full clashGG pb-20 text-white relative">
            <div className="">
                <Image className="absolute -left-20 -top-25 -z-10 hue-rotate-100 blur-3xl opacity-40 -rotate-6 animate-float" alt="chip" src={'/9011.png'} width={400} height={400} />
            ...
            <div className="">
                <Image className="absolute -right-20 -top-25 -z-10 hue-rotate-100 blur-3xl opacity-40 scale-x-[-1] rotate-6 animate-float" alt="chip" src={'/9011.png'} width={400} height={400} />
                    ...
                    {loading ? <div className="w-full h-screen flex justify-center items-center">
                        ...
                        <div className="min-h-screen flex items-center justify-center p-8">
                            <div ref={cardsRef} className="w-full flex justify-center gap-14 perspective">
                                {/* Silver - 2nd Place */}
                                <div className="relative rounded-xl border-2 translate-y-12 border-slate-600/50 hover:border-slate-400/80 bg-gradient-to-br from-card via-[#0a1c05] to-card rotate-3d-right hover:scale-110 group transition-all duration-500 ease-out shadow-2xl hover:shadow-slate-400/20 transform-gpu">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="rounded-xl border-2 relative border-amber-600/40 hover:border-amber-500/70 bg-gradient-to-br from-card via-[#0a1c05] to-card hover:scale-110 transition-all duration-500 group ease-out shadow-2xl hover:shadow-amber-400/20 transform-gpu">
                                ...
                                {/* Bronze - 3rd Place */}
                                <div className="rounded-xl border-2 translate-y-12 border-orange-950 hover:border-orange-700/80 bg-gradient-to-br from-card via-[#0a1c05] to-card relative rotate-3d-left hover:scale-110 group transition-all duration-500 ease-out shadow-2xl hover:shadow-orange-600/20 transform-gpu">
