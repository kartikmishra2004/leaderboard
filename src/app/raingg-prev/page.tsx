...
export default function RainGGPrev() {
    ...
    return (
        <section ref={mainRef} className="w-full rainGG pb-20 text-white relative">
            <div className="">
                ...
                <Image ref={topLeftChip} className="absolute -left-20 -top-25 -z-10 hue-rotate-200 -rotate-6 animate-float" alt="chip" src={'/9011.png'} width={400} height={400} />
            </div>
            <div className="">
                ...
                <Image ref={topRightChip} className="absolute -right-20 -top-25 -z-10 hue-rotate-200 scale-x-[-1] rotate-6 animate-float" alt="chip" src={'/9011.png'} width={400} height={400} />
            </div>
            <div className="w-full flex flex-col py-10 items-center">
                <div className="flex justify-center mt-12 items-center w-full">
                    ...
                    <div className="space-y-1 flex flex-col items-center relative px-7">
                        ...
                        <h1 className="text-4xl text-primary font-extrabold flex items-center gap-1">RAIN<span className="text-secondary">GG</span><sup className="text-sm font-normal">(PREV)</sup></h1>
    ...
    hover:shadow-[0_0_30px_rgba(59,130,246,0.8),0_0_60px_rgba(59,130,246,0.3)]
    hover:scale-110 hover:from-blue-600 hover:via-blue-500 hover:to-blue-700
    active:scale-105
